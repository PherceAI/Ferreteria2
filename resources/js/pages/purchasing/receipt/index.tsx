...
const TIMELINE = [
    {
        time: '09:31',
        prefix: 'Diferencia detectada:',
        text: 'Clavo Acero 2" (7 cjs faltantes) — Ideal Alambrec',
        type: 'error',
    },
    {
        time: '09:30',
        prefix: 'Recepción registrada:',
        text: 'Juan Morocho confirmó ingreso parcial — Ideal Alambrec',
        type: 'receipt',
    },
    {
        time: '07:00',
        prefix: 'Alerta de tiempo:',
        text: 'Factura de Plastigama lleva 1 día sin recepción física',
        type: 'warning',
    },
    {
        time: 'Ayer 16:45',
        prefix: 'Compra validada:',
        text: 'Disensa Ecuador — 100 qq Cemento + 500 Bloques — Todo coincide',
        type: 'success',
    },
    {
        time: 'Ayer 14:23',
        prefix: 'Factura detectada en Gmail:',
        text: 'Ideal Alambrec — $325.00',
        type: 'invoice',
    },
];
...
const StepIndicator = ({
    ...
    let lineClasses =
        'h-1 w-12 sm:w-16 transition-colors duration-300 rounded-full';
    ...
    if (errorStep === stepNum) {
        ...
        circleClasses +=
            ' border-neutral-300 bg-white text-neutral-400 dark:border-zinc-700 dark:bg-zinc-900';
        lineClasses += ' bg-neutral-200 dark:bg-zinc-800';
    }
    ...
    return (
        <div className="flex items-center">
            <div className="flex flex-col items-center">
                ...
                <span className="mt-2 hidden text-xs font-medium whitespace-nowrap text-neutral-500 sm:block">
                    {label}
                </span>
            </div>
            {stepNum < 4 && (
                <div
                    className={`mx-2 sm:mx-4 ${lineClasses} mt-4 self-start`}
                />
            )}
        </div>
    );
            ...
            <div className="flex flex-col gap-6 p-6 pb-32 font-sans">
                ...
                <div>
                    ...
                    <p className="text-sm text-neutral-500 dark:text-zinc-400">
                        Cruce automático: Orden de Compra → Factura → Recepción
                        Física
                    </p>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card className="border-neutral-200 shadow-none dark:border-zinc-800">
                        ...
                        <CardContent>
                            <div className="text-2xl font-semibold tracking-[-0.02em] text-red-600">
                                1
                            </div>
                            <span className="text-xs text-neutral-500">
                    ...
                    <Card className="border-neutral-200 shadow-none dark:border-zinc-800">
                        ...
                        <CardContent>
                            <div className="text-2xl font-semibold tracking-[-0.02em] text-green-600">
                                3
                            </div>
                            <span className="text-xs text-neutral-500">
                                Listas para registro en TINI
                            </span>
                        </CardContent>
                    </Card>
                </div>
                ...
                <div className="mt-2 flex flex-col gap-4">
                    ...
                    {MOCK_PURCHASES.map((purchase) => (
                        <Collapsible
                            key={purchase.id}
                            className="group overflow-hidden rounded-xl border border-neutral-200 bg-white transition-all dark:border-zinc-800 dark:bg-zinc-900"
                        >
                            <CollapsibleTrigger className="flex w-full items-center justify-between p-5 hover:bg-neutral-50 dark:hover:bg-zinc-800/50">
                                <div className="flex flex-col gap-1 text-left md:flex-row md:items-center md:gap-4">
                                    <div className="w-48 font-medium text-neutral-900 dark:text-zinc-50">
                                        {purchase.supplier}
                                    </div>
                            ...
                            <CollapsibleContent className="border-t border-neutral-100 bg-neutral-50/50 p-5 px-6 dark:border-zinc-800 dark:bg-zinc-950/50">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <p>
                                                    ...
                                                    registrada en TINI indica 50
                                                    cajas, pero bodega solo
                                                    recibió 43. Faltan 7 cajas.
                                                </p>
                                                <div>
                                                    <strong>
                                                        Atención — Descuadre en
                                                        TINI:
                                                    </strong>
                                ...
                                {purchase.status === 'VALIDADA' && (
                                    <div className="mb-6 flex items-center justify-between rounded-lg border border-green-200 bg-green-50 p-4 text-sm text-green-900 dark:border-green-900/50 dark:bg-green-950/30 dark:text-green-300">
                                        <p>
                                            <strong>Cruce exitoso.</strong> La
                                            mercancía recibida físicamente en
                                            bodega coincide exactamente con la
                                            factura que contabilidad registró en
                                            TINI. El stock es real y seguro para
                                            la venta.
                                        </p>
                                        <Button
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <p>
                                                    ...
                                                    Contabilidad ya registró la
                                                    factura en TINI el{' '}
                                                    {purchase.invoiceDate}, pero{' '}
                                                    <strong>
                                                        la mercancía aún no
                                                        llega a bodega
                                                    </strong>
                                                ...
                                                <p>
                                                    ...
                                                    1 día, 8 horas sin ingreso
                                                    físico.
                                                </p>
                                                <p className="text-amber-700">
                                                    <strong>Importante:</strong>{' '}
                                                    TINI muestra este stock como
                                                    disponible. Se ha emitido
                                                    una advertencia a Ventas
                                                    para evitar que ofrezcan
                                                    mercancía que físicamente no
                                                    existe en percha.
                                                </p>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <p>
                                                    ...
                                                    en TINI. Bodega debe
                                                    confirmar si las cantidades
                                                    físicas coinciden
                                                    exactamente con lo facturado
                                                    en cuanto se descargue la
                                                    mercancía.
                                                </p>
                                                <div className="mt-2 flex flex-wrap gap-2">
                                                    <Button
                                ...
                                {/* DATA TABLE */}
                                <div className="mb-6 overflow-x-auto rounded-lg border border-neutral-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
                                        ...
                                        <tbody className="divide-y divide-neutral-200 dark:divide-zinc-800/50">
                                            {purchase.products.map(
                                                (prod, idx) => (
                                                    ...
                                                    >
                                                        <td className="px-4 py-3 font-medium text-neutral-900 dark:text-zinc-50">
                                                            {prod.name}
                                                        </td>
                                                        <td
                                                            className={`px-4 py-3 ${prod.oc === 'No hay OC' ? 'font-semibold text-red-500' : 'text-neutral-600 dark:text-neutral-400'}`}
                                                        >
                                                            {prod.oc}
                                                        </td>
                                                        <td className="px-4 py-3 font-medium text-neutral-700 dark:text-zinc-300">
                                                            {prod.inv}
                                                        </td>
                                                        <td
                                                            className={`px-4 py-3 font-bold ${prod.state === 'Diferencia' ? 'text-red-600' : 'text-neutral-900 dark:text-zinc-50'}`}
                                                        >
                                                            {prod.rec}
                                                        </td>
                                                        <td className="px-4 py-3 text-right">
                                                            ...
                                                            {prod.state ===
                                                                'Sin autorización' && (
                                                                <span className="flex items-center justify-end gap-1 font-medium text-orange-600">
                                ...
                                <div className="font-mono text-xs text-neutral-500">
                                    <div className="mb-2 font-sans font-semibold text-neutral-700 dark:text-neutral-300">
                                        Trazabilidad:
                                    </div>
                ...
                <div className="mt-6 flex flex-col gap-4">
                    <h2 className="text-xs font-semibold tracking-wider text-neutral-500 uppercase dark:text-zinc-400">
                        ACTIVIDAD RECIENTE
                    </h2>
                            ...
                            {TIMELINE.map((item, idx) => (
                                ...
                                >
                                    <div className="relative flex items-center justify-center">
                                        ...
                                        {item.type === 'error' && (
                                            <div className="z-10 flex h-6 w-6 items-center justify-center rounded-full bg-red-50 text-red-500 ring-4 ring-white dark:bg-red-500/20 dark:ring-zinc-900">
                                                <AlertTriangle className="h-3 w-3" />
                                            </div>
                                        )}
                                        {item.type === 'receipt' && (
                                            <div className="z-10 flex h-6 w-6 items-center justify-center rounded-full bg-blue-50 text-blue-500 ring-4 ring-white dark:bg-blue-500/20 dark:ring-zinc-900">
                                                <Package className="h-3 w-3" />
                                            </div>
                                        )}
                                        {item.type === 'invoice' && (
                                            <div className="z-10 flex h-6 w-6 items-center justify-center rounded-full bg-neutral-100 text-neutral-500 ring-4 ring-white dark:bg-zinc-800 dark:ring-zinc-900">
                                                <Mail className="h-3 w-3" />
                                            </div>
                                        )}
                                        {item.type === 'warning' && (
                                            <div className="z-10 flex h-6 w-6 items-center justify-center rounded-full bg-amber-50 text-amber-500 ring-4 ring-white dark:bg-amber-500/20 dark:ring-zinc-900">
                                                <Clock className="h-3 w-3" />
                                            </div>
                                        )}
                                        {item.type === 'success' && (
                                            <div className="z-10 flex h-6 w-6 items-center justify-center rounded-full bg-green-50 text-green-500 ring-4 ring-white dark:bg-green-500/20 dark:ring-zinc-900">
                                                <CheckCircle2 className="h-3 w-3" />
                                            </div>
                                        )}
                                    </div>
                                    <div className="flex w-full items-center gap-4 pt-0.5">
                                        <div className="w-16 shrink-0 text-xs font-medium text-neutral-500">
                                            {item.time}
                                        </div>
                                        <div
                                            className={`text-sm ${item.type === 'error' ? 'text-red-600 dark:text-red-400' : 'text-neutral-600 dark:text-zinc-300'}`}
                                        >
