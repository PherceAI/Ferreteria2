...
function StatusBadge({ status }: { status: Vehicle['status'] }) {
    ...
    return (
        <span
            className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs font-semibold ${cfg.classes}`}
        >
                ...
                {vehicles.length === 0 && !loading && (
                    <div className="flex flex-col items-center justify-center gap-4 rounded-xl border border-dashed border-neutral-200 bg-white py-20 dark:border-zinc-800 dark:bg-zinc-900">
                        ...
                        <div className="text-center">
                            <p className="font-medium text-neutral-600 dark:text-zinc-300">
                                Sin datos de flota
                            </p>
                            <p className="mt-1 text-sm text-neutral-400">
                                Presiona "Actualizar Flota" para cargar la
                            ...
                            <div className="flex flex-col gap-3 rounded-xl border border-amber-200 bg-amber-50/40 p-5 dark:border-amber-900/40 dark:bg-amber-950/10">
                                ...
                                <div className="flex flex-col gap-2">
                                    {alerts.map((a, i) => (
                                        <div
                                            key={i}
                                            className="flex items-start gap-3 rounded-lg bg-white p-3 shadow-sm ring-1 ring-neutral-200 dark:bg-zinc-900 dark:ring-zinc-800"
                                        >
                                            <div
                            ...
                            <div className="block lg:hidden">
                                <div className="flex flex-col gap-3">
                                    {vehicles.map((v) => (
                                        <div
                                            key={v.id}
                                            className="rounded-xl border border-neutral-200 bg-white p-4 shadow-none dark:border-zinc-800 dark:bg-zinc-900"
                                        >
                                            <div className="flex items-start justify-between gap-2">
                                                <div>
                                                    ...
                                                    <p className="mt-0.5 text-xs text-neutral-500">
                                                        {v.total_distance_km.toLocaleString()}{' '}
                                                        km totales
                                                    </p>
                                                </div>
                                                <StatusBadge
